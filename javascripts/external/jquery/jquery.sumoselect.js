...
(function ($) {
    ...
    $.fn.SumoSelect = function (options) {
        ...
        var settings = $.extend({
            placeholder: 'Selecteer filters',   // Dont change it here.
            csvDispCount: 3,              // display no. of items in multiselect. 0 to display all.
            captionFormat:'{0} geselecteerd', // format of caption text. you can set your locale.
            captionFormatAllSelected:'Allemaal geselecteerd!', // format of caption text when all elements are selected. set null to use captionFormat. It will not work if there are disabled elements in select.
